...
import { getLocations } from '../../modules/AnimalManager';
...
export const AnimalForm = () => {
    ...
    useEffect(()=>{getLocations().then(response => setLocations(response))},[])
    useEffect(()=>{getCustomers().then(response => setCustomers(response))},[])
